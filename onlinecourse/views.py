...
def submit(request, course_id):
    Enrollment.objects.get(user=request.user, course=Course.objects.get(pk=course_id))
    submission = Submission.objects.create(enrollment=Enrollment.objects.get(user=request.user, course=Course.objects.get(pk=course_id)))
    submitted_anwsers = extract_answers(request)    
    submission.choices.set(Choice.objects.filter(id__in=submitted_anwsers))
